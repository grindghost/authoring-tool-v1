<template>
      <div v-if="isMounted && message" class="overlay-content fadeInScale">
        ...
        <!-- <fa icon="fa-solid fa-circle-exclamation" class="fa-beat overlay-icon" @click="handleIconClick" /> -->
        <fa v-if="isMounted" :icon="['fas', 'circle-exclamation']" class="fa-beat overlay-icon" />
...
<script setup>
    ...
    const message = computed (() => {
      return appStore.unitProfile?.message;

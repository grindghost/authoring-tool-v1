...
<template>
    <section class="relative pt-24 lg:pt-40 pb-14 overflow-x-hidden">
        ...
        <div class="relative px-6 mx-auto max-w-7xl">
            <div class="w-full mx-auto text-center md:w-11/12 xl:w-9/12 md:text-center">
                ...
                <div class="mb-4 space-x-2 md:space-x-2 md:mb-8">
                    <a href="#pricing" class="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg text-white bg-primary rounded-lg sm:w-auto sm:mb-0 hover:bg-secondary max-w-56">
                        Débuter
                        <svg class="w-4 h-4 ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                        </svg>
                    </a>
                    <a href="#_" class="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg text-gray-700 bg-gray-100 rounded-lg sm:w-auto sm:mb-0 hover:bg-gray-200 max-w-56">
                        Détails
            ...
            <div class="w-full mx-auto mt-8 lg:mt-[3.5rem] md:w-10/12">
                <div class="relative z-0 w-full mt-8">
                    <div class="relative -mr-6 md:mr-0">
                        <div class="relative shadow-2xl min-w-[190%] md:min-w-full">
                            <div class="flex items-center flex-none px-4 bg-gray-200 rounded-t-xl h-11">

...
<template>
    <section class="relative pt-32 lg:pt-32 pb-14 overflow-x-hidden">
        ...
        <svg
            ...
            viewBox="0 0 122 37"
            class="w-32 md:w-48 hover:fill-slate-800 m-auto mb-8"
          >
            ...
            <div class="w-full mx-auto text-center md:w-11/12 xl:w-9/12 md:text-center">
                <h1 class="mb-8 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-7xl lg:text-10xl md:mb-12">
                    ...
                    <span class="relative whitespace-nowrap"><span class="absolute bg-neutral-content -left-2 -top-1 -bottom-1 -right-2 md:-left-3 md:-top-0 md:-bottom-0 md:-right-3 -rotate-1"></span><span class="relative text-neutral">une réflexion </span></span> <span class="ml-3 md:ml-6">à la fois</span>
                ...
                <div class="mb-4 space-x-2 md:space-x-2 md:mb-4">
                    ...
                    <a href="#_" class="hidden sm:inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg text-gray-700 bg-gray-100 rounded-lg sm:w-auto sm:mb-0 hover:bg-gray-200 max-w-56">
                        Docs

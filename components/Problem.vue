<template>
    <section data-theme="dark" class="bg-neutral text-neutral-content">
      <div class="max-w-7xl mx-auto px-8 py-16 md:py-32 text-center">
        ...
        <div class="flex flex-col md:flex-row justify-center items-center md:items-start gap-6">
          ...
          <div class="w-full md:w-48 flex flex-col gap-2 items-center justify-center">
            ...
            <h3 class="font-bold">8 hrs to add Stripe</h3>
          </div>
  
          <!-- Arrow -->
          <svg
            class="shrink-0 w-12 fill-neutral-content opacity-70 max-md:-scale-x-100 md:-rotate-90"
            viewBox="0 0 138 138"
            fill="none"
          ...
          <div class="w-full md:w-48 flex flex-col gap-2 items-center justify-center">
            <span class="text-4xl">😮‍💨</span>
            <h3 class="font-bold">Struggle to find time</h3>
          </div>
  
          <!-- Arrow -->
          <svg
            class="shrink-0 w-12 fill-neutral-content opacity-70 md:-scale-x-100 md:-rotate-90"
            viewBox="0 0 138 138"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
